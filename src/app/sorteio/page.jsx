...
const inputClass =
  "w-full rounded-md border border-[#DDE0E6] px-3 py-2 text-sm outline-none focus:border-brand-red";
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#F5F6F3] px-4">
        <div className="w-full max-w-sm overflow-hidden rounded-xl border border-[#DDE0E6] bg-white text-center shadow-sm">
          ...
          <div className="p-8">
            <ContattosLogo size="md" className="mb-6 justify-center" />
            ...
            <div className="mb-6 rounded-lg bg-gradient-to-r from-brand-amber via-brand-orange to-brand-red py-4 text-3xl font-extrabold tracking-widest text-white shadow-sm">
              {raffleNumber}
            </div>
            <button
              onClick={() => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F5F6F3] px-4 py-10">
      <form
        ...
        className="w-full max-w-sm overflow-hidden rounded-xl border border-[#DDE0E6] bg-white shadow-sm"
      >
        <div className="h-1.5 bg-gradient-to-r from-brand-amber via-brand-orange to-brand-red" />
        <div className="p-8">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full rounded-md bg-gradient-to-r from-brand-amber via-brand-orange to-brand-red py-2 text-sm font-bold text-white shadow-sm transition-opacity hover:opacity-90 disabled:opacity-60"
          >
